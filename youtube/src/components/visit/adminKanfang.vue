...
<!--        </el-form-item>-->
        ...
        <!--        </el-form-item>-->
                ...
                <el-form-item label="预约编号" :label-width="formLabelWidth" prop="showNumber">
                  <el-input v-model="form.showNumber" autocomplete="off"></el-input>
                </el-form-item>
...
<script>
    export default {
      ...
      data() {
        return {
          dialogFormVisible: false,//点击就跳出表格
          form: {
        ...
        onAdd(){
          this.$axios
            ...
            if (resp && resp.status == 200) {
              ...
              this.$toastMessage("修改看房时间成功", 3000)
              this.$emit('onAdd')
            }
          })
        }
